...
for index in range(1, 3):
    ...
    for i in range(1, 41):
        ...
        if mainrandom == 1 and type1counter == 10:
            mainrandom = 2
        if mainrandom == 2 and type2counter == 10:
            mainrandom = 3
        if mainrandom == 3 and type3counter == 10:
            mainrandom = 4
        if mainrandom == 4 and type4counter == 10:



            if type3counter < 10:
                mainrandom = 3
            elif type2counter < 10:
                mainrandom = 2
            elif type1counter < 10:
                mainrandom = 1
        ...
        if mainrandom == 1:
            ...
            if gender_random == 1 and onemale == 5:
                gender_random = 0
            elif gender_random == 0 and onefemale == 5:
                gender_random = 1
        ...
        if mainrandom == 2:
            ...
            if gender_random == 1 and twomale == 5:
                gender_random = 0
            elif gender_random == 0 and twofemale == 5:
                gender_random = 1
        ...
        if mainrandom == 3:
            ...
            if gender_random == 1 and threemale == 5:
                gender_random = 0
            elif gender_random == 0 and threefemale == 5:
                gender_random = 1
        ...
        if mainrandom == 4:
            ...
            if gender_random == 1 and fourmale == 5:
                gender_random = 0
            elif gender_random == 0 and fourfemale == 5:
                gender_random = 1
