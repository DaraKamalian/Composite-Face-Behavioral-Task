...
class MainAssets(object):
    ...
    firstInstructionImage = visual.ImageStim(win, image='images/instruction-same-L-1.jpg', pos=[-40, 45],
                                                   units='pix',
                                                   size=[1200, 720])
    secondInstructionImage = visual.ImageStim(win, image='images/instruction-same-L-3.jpg', pos=[-40, 45],
                                             units='pix',
                                             size=[1200, 720])
